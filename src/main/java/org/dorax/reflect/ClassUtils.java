...
public class ClassUtils {
    ...
    public ClassUtils find(Test test, String packageName) {
        ...
        try {
            List<String> children = Objects.requireNonNull(AbstractVfs.getInstance()).list(path);
...
abstract class AbstractVfs {
     ...
     */
    public static final List<Class<? extends AbstractVfs>> USER_IMPLEMENTATIONS = new ArrayList<>();
    ...
    /**
     * Get the singleton {@link AbstractVfs} instance. If no {@link AbstractVfs} implementation can be found for the
    ...
    public static AbstractVfs getInstance() {
        ...
        return AbstractVfs.instance = vfs;
    }

    /**
     * Adds the specified class to the list of {@link AbstractVfs} implementations. Classes added in this
    ...
    /**
     * Return true if the {@link AbstractVfs} implementation is valid for the current environment.
     *
 ...
 * @date 2020-04-10
 */
class DefaultVfs extends AbstractVfs {
    private static final Logger log = LoggerFactory.getLogger(ClassUtils.class);
     ...
     *
     * @param url    The URL of the resource to test.
     * @param buffer A buffer into which the first few bytes of the resource are read.
     *               The buffer must be at least the size of {@link #JAR_MAGIC}.
     *               (The same buffer may be reused for multiple calls as an optimization.)
     */
 ...
 * @date 2020-04-10
 */
class Jboss6Vfs extends AbstractVfs {
    private static final Logger log = LoggerFactory.getLogger(ClassUtils.class);
