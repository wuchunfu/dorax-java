...
public class ByteUtils {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ByteUtils.formatByteSize((long) UNIT * UNIT));
        System.out.println(ByteUtils.formatByteSize((long) UNIT * 1023));
        System.out.println(ByteUtils.formatByteSize((long) 1023 * 1023 * 1023));
        System.out.println(ByteUtils.formatByteSize((long) UNIT * UNIT * UNIT));
        System.out.println(ByteUtils.formatByteSize((long) UNIT * UNIT * UNIT * UNIT));
        System.out.println(ByteUtils.formatByteSize((long) UNIT * UNIT * UNIT * UNIT * UNIT));
        System.out.println(ByteUtils.formatByteSize((long) UNIT * UNIT * UNIT * UNIT * UNIT * UNIT));
    }
}
